...
- [x] Melhorar pesquisa.
- [ ] Revisar destaque dos resultados.
- [x] Otimizar carregamento.
- [ ] Evoluir mapa de conhecimento.
- [ ] Melhorar revisão de conceitos e perguntas.
- [ ] Melhorar estados vazios e feedback visual.
- [ ] Revisar comportamento offline.
- [ ] Reduzir operações desnecessárias durante carregamento.

---

## IA no Brain

A IA deve funcionar principalmente como uma camada de organização, análise e
apoio ao estudo.

O objetivo não é substituir o conhecimento registrado pelo usuário nem
transformar o Brain em um chatbot genérico.

A IA deve trabalhar sobre o conteúdo já existente no cérebro do usuário.

### Princípios

- [ ] A IA não deve substituir automaticamente o conteúdo original do usuário.
- [ ] A IA nunca recebe o conhecimento total, ela recebe apenas recebe uma
      representação compacta com os metadados
- [ ] O conteúdo original deve continuar sendo a fonte principal.
- [ ] A IA deve organizar, relacionar e resumir quando solicitado.
- [ ] Sugestões da IA devem ser claramente identificadas como sugestões.
- [ ] O usuário deve continuar no controle sobre o que é salvo.
- [ ] A IA não deve modificar conhecimento permanentemente sem ação explícita do
      usuário.
- [ ] Processamentos devem respeitar as regras de privacidade e segurança do
      produto.
...
- [ ] Mostrar possíveis caminhos de estudo.
...
- [ ] sugerir revisões relacionadas;
- [ ] identificar respostas superficiais;
- [ ] sugerir assuntos que merecem aprofundamento.
...
- [ ] evitar processar todo o Brain a cada ação;
...
A IA não deve precisar reler todo o Brain a cada novo conceito.
...
12. melhora diretamente a experiência principal do Brain.
