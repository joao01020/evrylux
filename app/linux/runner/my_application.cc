...
// ============================================================
//
// Mostra a janela somente quando o Flutter renderizar
// o primeiro frame.
//
// ============================================================
    ...
    GApplication *application)
{
  ...
  // ==========================================================
  //
  // Cada janela criada pelo desktop_multi_window possui
  // seu próprio Flutter Engine.
  //
  // Portanto precisamos registrar novamente todos os plugins
  // para cada nova janela.
  //
  // Isso inclui:
  //
    ...
    int *exit_status)
{
  ...
  // Remove o primeiro argumento porque ele é o nome
  // do executável.
...
{
  // Define o nome do programa para o application ID.
  //
  // Isso ajuda GNOME, KDE e outros ambientes desktop
  // a identificar corretamente a aplicação.
