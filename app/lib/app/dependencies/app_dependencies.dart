...
notifyAppUserChanged(
  ...
  accountStartupCoordinator.setUser(
    userId,
  );
}
...
Future<
  void
>
initializeAuthenticatedOfflineFirst(
  String userId,
) {
  return accountStartupCoordinator.ensure(
    userId,
  );
}
...
Future<
  void
>
_initializeAuthenticatedOfflineFirst(
  String userId,
  void Function() check,
) async {
  // ====================================================
