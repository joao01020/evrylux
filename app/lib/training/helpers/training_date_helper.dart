class TrainingDateHelper {
  ...
  static Set<int> normalizeWeekdays(Iterable<int> weekdays) {
  ...
  static List<int> sortWeekdays(Iterable<int> weekdays) {
    final ordered = normalizeWeekdays(weekdays).toList();
  ...
  static List<String> weekdayNames(Iterable<int> weekdays) {
    return sortWeekdays(weekdays).map((weekday) {
  ...
  static String weekdaysText(Iterable<int> weekdays) {
    final names = weekdayNames(weekdays);
    ...
    final text = names.take(names.length - 1).map(capitalize).join(', ');
