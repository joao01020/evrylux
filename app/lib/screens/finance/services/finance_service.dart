...
class FinanceService {
  ...
  FinanceService({required this.repository});
  ...
  static String calculateEstimate({
    ...
    final months = (missing / monthly).ceil();
  ...
  Future<void> saveFinance(FinanceModel model) async {
  ...
  Future<void> clearFinance() async {
    await repository.save({});
  }
}
