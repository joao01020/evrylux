...
class FinanceHistoryScreen extends StatefulWidget {
  ...
  final Future<void> Function(InvestmentHistory item) onDelete;
...
class _FinanceHistoryScreenState extends State<FinanceHistoryScreen> {
  ...
  void _showHistoryItem(InvestmentHistory item) {
    final value = FinanceScreenFormatter.currency(item.safeValue);

    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('$value • ${item.normalizedRhythm}')),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Histórico de aportes')),
