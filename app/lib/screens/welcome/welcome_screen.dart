...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  void openObjective(String name) {
    ...
    switch (name) {
      ...
      case "Evolução":
        page = EvolutionScreen(controller: widget.controller);
        ...
        child: Stack(
          children: [
            AnimatedAlign(
              ...
              alignment: showOptions ? Alignment.topCenter : Alignment.center,

              child: Padding(
                padding: EdgeInsets.only(top: showOptions ? 70 : 0),
            ...
            AnimatedOpacity(
              ...
              child: AnimatedSlide(
                ...
                offset: showOptions ? Offset.zero : const Offset(0, 0.25),
